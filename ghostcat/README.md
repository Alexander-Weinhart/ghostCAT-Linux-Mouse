...
GhostCAT is a GTK+ application to configure gaming mice. GhostCAT is merely a
...
Supported Devices
=================
GhostCAT is merely a frontend, the list of supported devices depends on
...
See [our Wiki](https://github.com/libratbag/piper/wiki/Installation) for how to install GhostCAT.

Building GhostCAT from git
=======================

GhostCAT uses the [meson build system](http://mesonbuild.com/). Run the following
commands to clone GhostCAT and initialize the build:
...
the devices displayed by GhostCAT come from libratbag.
...
GhostCAT tries to conform to Python's PEP8 style guide using the `black` formatter.
