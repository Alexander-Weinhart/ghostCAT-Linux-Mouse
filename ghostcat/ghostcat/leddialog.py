...
from .ghostcatd import RatbagdLed
...
@Gtk.Template(resource_path="/org/freedesktop/GhostCAT/ui/LedDialog.ui")
class LedDialog(Gtk.Dialog):
    ...
    def __init__(self, ghostcatd_led: RatbagdLed, *args, **kwargs) -> None:
        """Instantiates a new LedDialog.

        @param ghostcatd_led The LED to configure, as ghostcatd.RatbagdLed.
        """
        Gtk.Dialog.__init__(self, *args, **kwargs)
        self._led = ghostcatd_led
        self._modes = {
    ...
    def _get_led_color_as_rgba(self) -> Gdk.RGBA:
        # Helper function to convert ghostcatd's 0-255 color range to a Gdk.RGBA
