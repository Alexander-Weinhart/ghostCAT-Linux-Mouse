...
@Gtk.Template(resource_path="/org/freedesktop/GhostCAT/ui/WelcomePerspective.ui")
class WelcomePerspective(Gtk.Box):
    ...
    def set_devices(self, devices: List[RatbagdDevice]) -> None:
        ...
        @param devices The devices to present, as [ghostcatd.RatbagdDevice]
        """
    ...
    def add_device(self, device: RatbagdDevice) -> None:
        ...
        @param device The device to add, as ghostcatd.RatbagdDevice
        """
    ...
    def remove_device(self, device: RatbagdDevice) -> None:
        ...
        @param device The device to remove, as ghostcatd.RatbagdDevice
        """
